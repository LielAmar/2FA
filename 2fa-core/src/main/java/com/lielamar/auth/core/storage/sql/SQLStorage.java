...
public class SQLStorage extends StorageHandler {
    ...
    public SQLStorage(String driver, String host, String database, String username, String password, int port,
        ...
        try {
            ...
            loaded = false;
            throw new IllegalStateException("Something went wrong when setting up HikariCP. If something does not work"
    ...
    protected void createTables() {
        ...
        try {
            ...
            try {
                ...
                loaded = false;
                throw new IllegalStateException("The plugin could not add the 'enable_date' column to your SQL database in table: " + this.fullPlayersTableName + "."
