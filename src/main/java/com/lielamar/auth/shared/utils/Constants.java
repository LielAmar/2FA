...
public class Constants {
    ...
    public static final Pair<String, String> MAIN_COMMAND = new Pair<>("2fa", "2fa.use");
    ...
    public static final Pair<String, String> DISABLE_FOR_OTHERS_COMMAND = new Pair<>("", "2fa.remove.others");
